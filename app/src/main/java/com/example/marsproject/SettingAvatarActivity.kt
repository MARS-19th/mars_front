...
class SettingAvatarActivity : AppCompatActivity(), EquipmentAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 기본 이미지를 고양이 아바타로 설정
        binding.avatarImage.setImageResource(com.example.marsproject.R.drawable.cat1_emo1)
    ...
    override fun onItemClick(expression: String, expressionAppearance: String) {
        ...
        when (expressionAppearance) {
            "테스트 외형 1" -> appearance = "cat1_"
            "테스트 외형 2" -> appearance = "cat2_"
            "테스트 외형 3" -> appearance = "cat3_"
        ...
        val resourceId = resources.getIdentifier("$appearance$face", "drawable", packageName)
    ...
    private fun updateEquipmentItemsForBottoms() {
        ...
        for (i in 0 until equipmentNames.size) {
            ContextCompat.getDrawable(this, resources.getIdentifier("cat${i + 1}_", "drawable", packageName))?.let { drawable ->
